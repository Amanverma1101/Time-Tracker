...
//                    try {
//                        selectedOptionIndex = Integer.parseInt(boxData.getSelectedOption());
//                    } catch (NumberFormatException e) {
//                        boxTextView.setText(boxId + " | 🤨 | " + "Invalid option");
//                        return;
//                    }
//
//                    DatabaseReference labelsRef = mDatabase.getReference("user_data")
//                            .child(userId)
//                            .child("labels");
//
//                    int finalSelectedOptionIndex = selectedOptionIndex;
//                    labelsRef.addListenerForSingleValueEvent(new ValueEventListener() {
//                        @Override
//                        public void onDataChange(DataSnapshot labelsSnapshot) {
//                            DataSnapshot emojiSnapshot = labelsSnapshot.child(String.valueOf(finalSelectedOptionIndex -7));
...
//                    });
//                } else {
//                    boxTextView.setText(boxId + " | 😢 | No Data Available");
//                }
//            }
//
//            @Override
//            public void onCancelled(DatabaseError databaseError) {
//                boxTextView.setText("Failed to load data");
